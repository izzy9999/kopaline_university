...
<title><?php echo $title; ?> | Online Kopaline Student Management System.</title>
...
<div class="navbar-fixed-top navbar-TOPsm container "    role="navigation">
  <div class="container">
    <div class="navbar-header">
          <h5 class="navbar-menu p" >Online Kopaline Student Management System.</h5>
        ...
        <!-- <ul class="navbar-nav p navbar-left tooltip-demo" style="margin-left:-8%;"> 
            <li class="dropdown dropdown-toggle ">
              <a  data-toggle="tooltip" data-placement="left" title="Contact Us"   href="<?php echo web_root.'index.php?q=contact';  ?>"> 
               <i class="fa fa-phone fa-fw"> </i>  Call Us: (+260) 976728881 OR Email Us: kopalineoutlook@gmail.com
              </a>
            </li>
  ...
  <div class=" container stretch " style="margin-top:-30px;"> 
    <div class="row">
        <img  src="<?php echo web_root; ?>image/head1.pg"   >  
    </div>
  </div> 
...
?>
            ...
            <footer class="panel-footer" style="background-color:#025eb1;color:#fff;" >
              <p align="center" >&copy; Online Kopaline Student Management System.</p>
           </footer>
      </div>
